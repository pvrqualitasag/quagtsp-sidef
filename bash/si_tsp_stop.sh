#!/bin/bash
#' ---
#' title: Stop Singularity Container Instance For TheSNPpit
...
#'
#' ## Description
#' Stopping a singularity container image that runs a postgresql-db for TheSNPpit.
#'
#' ## Details
