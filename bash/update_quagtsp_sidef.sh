#!/bin/bash
#' ---
#' title: Update Repository quagtsp_sidef
#' date:  2020-05-10 12:30:51
#' author: Peter von Rohr
#' ---
#' ## Purpose
#' Seamless inital pull of the repository quagtsp_sidef. 
#'
#' ## Description
#' pull the repository quagtsp_sidef onto a new remote machine.
#'
#' ## Details
