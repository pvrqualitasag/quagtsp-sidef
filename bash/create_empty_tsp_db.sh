#!/bin/bash
#' ---
#' title: Create Empty TSP DB
#' date:  2021-07-13 11:45:31
#' author: Peter von Rohr
#' ---
#' ## Purpose
#' Seamless creation of empty database
#'
#' ## Description
#' Create an empty TSP database
#'
#' ## Details
#' Use example from demo.bat
#'
#' ## Example
#' ./create_empty_tsp_db.sh
#'
#' ## Set Directives
